...
If the user explicitly requests a recurrence cadence or other Calendar configuration outside the supported boundary — daily, weekly, biweekly, monthly, and bimonthly recurrence within a six-month horizon — do not silently reinterpret it as a one-off or a supported value. Set needsClarification to true and ask, naming the supported alternatives.
