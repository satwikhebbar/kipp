...
export const mealScheduleSchema: z.ZodType<MealSchedule> = z.object({
  days: z.array(z.string().min(1)).min(1),
  slots: z.array(mealSlotSchema).min(1),
})

export const dietaryExclusionSchema: z.ZodType<DietaryExclusion> = z.object({
  token: z.string().min(1),
  ambiguous: z.boolean(),
})

export const foodPreferencesSchema: z.ZodType<FoodPreferences> = z.object({
  favourites: z.array(z.string().min(1)),
  avoid: z.array(z.string().min(1)),
})

export const mealProfileSchema: z.ZodType<MealProfile> = z.object({
...
export const customPolicySchema: z.ZodType<CustomPolicy> = z.object({
  id: z.string().min(1),
...
export const inventoryItemSchema: z.ZodType<InventoryItem> = z.object({
  name: z.string().min(1),
...
export const weeklyInventorySchema: z.ZodType<WeeklyInventory> = z.object({
  items: z.array(inventoryItemSchema),
  notes: z.array(z.string()),
})

export const exceptionAppliesToSchema: z.ZodType<ExceptionAppliesTo> = z.object({
  day: z.string().min(1).optional(),
  mealSlots: z.array(z.string().min(1)).optional(),
})

export const weeklyExceptionSchema: z.ZodType<WeeklyException> = z.object({
  kind: z.enum(EXCEPTION_KINDS),
  appliesTo: exceptionAppliesToSchema.optional(),
  instruction: z.string().min(1),
})

export const weeklyExceptionsSchema: z.ZodType<WeeklyExceptions> = z.object({
...
export const feedbackItemSchema: z.ZodType<FeedbackItem> = z.object({
  id: z.string().min(1),
  text: z.string().min(1),
  scope: z.object({ day: z.string().optional(), slot: z.string().optional() }).optional(),
})

export const mealCellSchema: z.ZodType<MealCell> = z.object({
  dish: z.string().min(1),
  vegetarian: z.boolean(),
  ingredients: z.array(z.string().min(1)),
  inventoryItems: z.array(z.string().min(1)),
...
export const mealPlanContextSchema: z.ZodType<MealPlanContext> = z.object({
...
export const mealPlanCandidateSchema: z.ZodType<MealPlanCandidate> = z.object({
  grid: mealGridSchema,
  easyBuys: z.array(z.string().min(1)),
  policyOutcomes: z.record(z.string().min(1), policyOutcomeSchema),
})

export const mealPlanFailureExpectationSchema: z.ZodType<MealPlanFailureExpectation> = z.object({
...
export const mealPlanExpectationSchema: z.ZodType<MealPlanExpectation> = z.object({
  pass: z.boolean(),
...
export const scenarioBehaviorSchema: z.ZodType<ScenarioBehavior> = z.object({
...
export const mealPlanScenarioSchema: z.ZodType<MealPlanScenario> = z.object({
  id: z.string().min(1),
  name: z.string().min(1),
