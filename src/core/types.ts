...
export const INTERACTION_KIND = {
  ...
  CALENDAR_CONFLICT_DISCLOSE: "calendar-conflict-disclose",
  CALENDAR_CONFLICT_RESCHEDULE: "calendar-conflict-reschedule",
  CALENDAR_CONFLICT_MOVE: "calendar-conflict-move",
  CALENDAR_CONFLICT_UNDO: "calendar-conflict-undo",
  CALENDAR_CONFLICT_CONTINUE: "calendar-conflict-continue",
